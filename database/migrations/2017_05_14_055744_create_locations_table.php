    ...
    public function up()
    {
        ...
        $locations = [
            [
                ...
                "name"          => _t("Inn"),
                "description"   => _t("An establishment or building providing lodging and, usually, food and drink for travelers (Starting location)"),
            ...
            [
                "id"            => $this->generateUuid(),
                "name"          => _t("Town Hall"),
                "description"   => _t("Public forum or meeting in which those attending gather to discuss civic or political issues, hear and ask questions about the ideas of a candidate for public office"),
            ...
            [
                "id"            => $this->generateUuid(),
                "name"          => _t("Smithy"),
                "description"   => _t("A blacksmith's shop. A place to purchase weaponry and armor or train one's skill as a blacksmith"),
                "image"         => "locations/Blacksmith-800px.png",
                "image_sm"      => "locations/Blacksmith-300px.png",
            ],
            [
                "id"            => $this->generateUuid(),
                "name"          => _t("Military academy fortress"),
                "description"   => _t("An institute where soldiers and mercenaries train they martial skills"),
